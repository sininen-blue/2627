...
1. In your own words, what is the difference between `_physics_process` and `_integrate_forces`, and how is this related to the value `state`?
#v(10em)

2. Describe your understanding of the difference between static, kinematic, and rigid bodies
#v(10em)
